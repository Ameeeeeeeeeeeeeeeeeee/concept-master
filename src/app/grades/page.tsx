...
export default function GradesPage() {
  const subjects = [
    { slug: "english", icon: "📖", color: "from-blue-500 to-indigo-600" },
    { slug: "physics", icon: "⚡", color: "from-amber-500 to-orange-600" },
    { slug: "chemistry", icon: "🧪", color: "from-green-500 to-emerald-600" },
    { slug: "biology", icon: "🧬", color: "from-purple-500 to-pink-600" },
  ];
